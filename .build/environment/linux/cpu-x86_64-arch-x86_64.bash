...
mkdir -p "${SRC_DIR}/x86_64"

# OpenSSL Settings
OPENSSL_VERSION=1.1.0h
OPENSSL_HASH=5835626cde9e99656585fc7aaa2302a73a7e1340bf8c14fd635a62c66802a517
OPENSSL_SRC_DIR_AMD64="${SRC_DIR}/x86_64"
OPENSSL_SRC_DIR_ARM8="${SRC_DIR}/arm8"
OPENSSL_INSTALL_DIR_AMD64="${INSTALL_DIR}/x86_64/openssl-${OPENSSL_VERSION}"
OPENSSL_INSTALL_DIR_ARM8="${INSTALL_DIR}/arm8/openssl-${OPENSSL_VERSION}"
export OPENSSL_INSTALL_DIR_ARM8 OPENSSL_INSTALL_DIR_AMD64 OPENSSL_SRC_DIR_ARM8 OPENSSL_SRC_DIR_AMD64 OPENSSL_HASH OPENSSL_VERSION
...
BOOST_SRC_DIR_AMD64="${SRC_DIR}/x86_64"
BOOST_SRC_DIR_ARM8="${SRC_DIR}/arm8"
BOOST_INSTALL_DIR_AMD64="${INSTALL_DIR}/x86_64/boost_${BOOST_VERSION}"
BOOST_INSTALL_DIR_ARM8="${INSTALL_DIR}/arm8/boost_${BOOST_VERSION}"

export BOOST_VERSION BOOST_VERSION_DOT BOOST_HASH BOOST_SRC_DIR_AMD64 BOOST_SRC_DIR_ARM8 BOOST_INSTALL_DIR_AMD64 BOOST_INSTALL_DIR_ARM8
